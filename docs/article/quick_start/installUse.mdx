...
![upfile](../image/upfile.png)  
3. step3：安装`.vsix` app文件为app
![installApp](../image/installApp.png) 
4. step4：运行App
...
2. 注册或登录
3. 下拉选择`工作台`
![openSyslab](../image/openSyslab.png)  
4. 点击`打开SysLab Online`
![openSyslab](../image/enter.png)  
:::
